...
//import { Carousel, Card, CardGroup, Accordion, Figure } from 'react-bootstrap';
////import { SlIconName } from 'react-icons/sl'; // Example for 'sl' icon
//import { TiIconName } from 'react-icons/ti'; // Example for 'ti' icon
...
function ImageSlider() {
 ...
 <Card className="mb-2">
   ...
   <Card.Footer>
     <small className="text-muted">Use Code:OFFER20</small>
   </Card.Footer>
 </Card>
</CardGroup>
   </div>
